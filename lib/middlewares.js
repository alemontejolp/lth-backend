...
const buildAndRun = require('./build_and_run');
const validators = require('./validators');
const ProcessTracking = require('./process_traking');
...
midd.build = (req, res, next) => {
  //Hacer la compilación...
  buildAndRun.build(conf.sourcePath + req.file.filename, '../.' + conf.buildPath)
  .then(result => {
    if(!result.success) {
